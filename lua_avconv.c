...
static void avconv_cleanup(int ret)
{
    ...
    av_freep(&input_streams); input_streams = NULL ; nb_input_streams = 0;
    av_freep(&input_files);   input_files = NULL   ; nb_input_files = 0;
    av_freep(&output_streams);output_streams = NULL; nb_output_streams = 0;
    av_freep(&output_files);  output_files = NULL  ; nb_output_files = 0;
...
static int LUA_transcode(lua_State *L)
{
     /*
      *  Ussage:
      *  avconv_init = package.loadlib("./test.so", "luaopen_avconv");
      *  print(avconv_init);
      *  avconv_init();
